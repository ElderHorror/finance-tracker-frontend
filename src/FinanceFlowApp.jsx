...
function FinanceFlowApp() {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ category: "", amount: "", date: "", newCategory: "" });
  ...
  const isFormValid = () => {
    if (modalType === "expense") return formData.category && formData.amount;
    if (modalType === "category") return formData.newCategory;
    return true;
  };
